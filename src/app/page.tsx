...
export default function Home() {
  return (
    <>
      ...
      <section className="py-12 mt-16 container mx-auto w-full" id="service">
        ...
        <div className="grid justify-center sm:grid-cols-2 md:grid-cols-3 items-center space-y-12 mt-8 relative overflow-x-clip">
          <GradientBox height={120} width={60} fromColor="rgb(251, 168, 28, 0.26)" toColor="rgb(224, 86, 136, 0.15)" className="top-0 rotate-45" />
          {SERVICE.map((res) => (
          ...
          <GradientBox height={120} width={60} fromColor="rgb(84, 84, 212)" toColor="rgb(84, 84, 212, 0.4)" className="top-0 right-10 -rotate-45" />
        </div>
